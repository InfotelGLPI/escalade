...
xgettext *.php */*.php --copyright-holder='Escalade Development Team' --package-name='GLPI - Escalade plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
